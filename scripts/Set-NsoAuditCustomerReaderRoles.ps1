...
if (-not $servicePrincipal) {
    throw "The Enterprise Application for client ID '$ApplicationClientId' was not found in the current tenant. Complete tenant admin consent first."
}
...
Write-Host "Proposed read-only assignments for $($servicePrincipal.DisplayName):" -ForegroundColor Cyan
$assignments | ForEach-Object {
    Write-Host "  $($_.Role) at $($_.Scope)"
}
